...
# defines the folder path for uploads (submissions)
UPLOAD_FOLDER = os.path.join(g_BASE_DIR, 'uploads')

# defines the folder path for resources
RESOURCES_FOLDER = os.path.join(g_BASE_DIR, 'resources')
...
def create_app_config(myapp_obj):
    ...
    myapp_obj.config['UPLOADS'] = UPLOAD_FOLDER
    myapp_obj.config['RESOURCES'] = RESOURCES_FOLDER
